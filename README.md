...
```shell
gem install ./hello_sign-6.0.0-beta.gem
```

(for development, run `gem install --dev ./hello_sign-6.0.0-beta.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'hello_sign', '~> 6.0.0-beta'
