...
```shell
gem build hello_sign.gemspec
```

Then either install the gem locally:

```shell
gem install ./hello_sign-1.0.0.gem
```

(for development, run `gem install --dev ./hello_sign-1.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'hello_sign', '~> 1.0.0'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:

    gem 'hello_sign', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
## Documentation for Models
 ...
 - [HelloSign::SignatureRequestResponseCustomField](docs/SignatureRequestResponseCustomField.md)
 ...
 - [HelloSign::SubBulkSignerListSigner](docs/SubBulkSignerListSigner.md)
 ...
 - [HelloSign::SubSignatureRequestEmbeddedSigner](docs/SubSignatureRequestEmbeddedSigner.md)
 - [HelloSign::SubSignatureRequestEmbeddedTemplateSigner](docs/SubSignatureRequestEmbeddedTemplateSigner.md)
 ...
 - [HelloSign::SubUnclaimedDraftEmbeddedSigner](docs/SubUnclaimedDraftEmbeddedSigner.md)
 - [HelloSign::SubUnclaimedDraftEmbeddedTemplateSigner](docs/SubUnclaimedDraftEmbeddedTemplateSigner.md)
 ...
 - [HelloSign::TemplateResponseDocumentCustomFieldAvgTextLength](docs/TemplateResponseDocumentCustomFieldAvgTextLength.md)
